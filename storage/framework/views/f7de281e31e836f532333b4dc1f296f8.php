<?php $__env->startSection('page-title', 'Reset User Password'); ?>
...
<div class="max-w-lg mx-auto">
    <div class="mb-6">
        ...
        <p class="text-gray-500 text-sm mt-1">Setting new password for <strong><?php echo e($user->fullname); ?></strong></p>
    </div>
    <?php if($errors->any()): ?>
    ...
    <div class="bg-white rounded-xl shadow-sm border border-gray-100 p-6">
        <form method="POST" action="<?php echo e(route('admin.users.reset-password.update', $user->id)); ?>" class="space-y-4">
            <?php echo csrf_field(); ?>
            <div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\myglucotrack-laravel-v3\resources\views/admin/reset-password.blade.php ENDPATH**/ ?>