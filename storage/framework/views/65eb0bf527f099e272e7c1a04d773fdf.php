<?php $__env->startSection('page-title', 'Add Blood Sugar Record'); ?>
...
<div class="max-w-2xl mx-auto">
    ...
    <div class="mb-6">
        ...
        <h2 class="text-2xl font-bold text-gray-800 mt-2">Add Blood Sugar Record</h2>
    </div>
    ...
    <div class="bg-white rounded-xl shadow-sm border border-gray-100 p-6 space-y-5">
        ...
        <form method="POST" action="<?php echo e(route('blood-sugar.store')); ?>">
            <?php echo csrf_field(); ?>
            ...
            <div>
                ...
                <input type="number" step="0.1" name="blood_sugar_level"
                       value="<?php echo e(old('blood_sugar_level')); ?>"
                       placeholder="e.g. 5.4"
            ...
            <div>
                ...
                <select name="before_after" class="w-full border border-gray-300 rounded-lg px-3 py-2 text-sm focus:ring-2 focus:ring-blue-500 focus:border-blue-500" required>
                    <option value="Before Meal" <?php echo e(old('before_after') == 'Before Meal' ? 'selected' : ''); ?>>Before Meal</option>
                    <option value="After Meal" <?php echo e(old('before_after') == 'After Meal' ? 'selected' : ''); ?>>After Meal</option>
                </select>
            </div>
            ...
            <div class="grid grid-cols-2 gap-4">
                <div>
                    ...
                    <input type="date" name="measurement_date"
                           value="<?php echo e(old('measurement_date', date('Y-m-d'))); ?>"
                           class="w-full border border-gray-300 rounded-lg px-3 py-2 text-sm focus:ring-2 focus:ring-blue-500 focus:border-blue-500" required>
                </div>
                <div>
                    ...
                    <input type="time" name="measurement_time"
                           value="<?php echo e(old('measurement_time', date('H:i'))); ?>"
                           class="w-full border border-gray-300 rounded-lg px-3 py-2 text-sm focus:ring-2 focus:ring-blue-500 focus:border-blue-500" required>
                </div>
            </div>
            ...
            <div>
                ...
                <textarea name="notes" rows="3" placeholder="Any relevant observations..."
                          class="w-full border border-gray-300 rounded-lg px-3 py-2 text-sm focus:ring-2 focus:ring-blue-500 focus:border-blue-500"><?php echo e(old('notes')); ?></textarea>
            </div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\myglucotrack-laravel-v3\resources\views/blood/create.blade.php ENDPATH**/ ?>