...
<div class="max-w-lg mx-auto">
    <div class="mb-6">
        ...
        <p class="text-gray-500 text-sm mt-1">Setting new password for <strong>{{ $user->fullname }}</strong></p>
    </div>
    @if($errors->any())
    ...
    <div class="bg-white rounded-xl shadow-sm border border-gray-100 p-6">
        <form method="POST" action="{{ route('admin.users.reset-password.update', $user->id) }}" class="space-y-4">
            @csrf
            <div>
