        ...
        <form method="POST" action="{{ route('patients.store') }}" class="space-y-5">
            ...
            <div>
                ...
                <textarea name="address" rows="2" placeholder="e.g. No 12, Jalan Bahagia, 41000 Klang"
                          class="w-full border border-gray-300 rounded-lg px-3 py-2 text-sm focus:ring-2 focus:ring-blue-500 focus:border-blue-500">{{ old('address') }}</textarea>
            </div>
