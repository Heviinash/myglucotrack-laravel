...
<div class="max-w-2xl mx-auto">
    ...
    <div class="bg-white rounded-xl shadow-sm border border-gray-100 p-6">
        <form method="POST" action="{{ route('patients.update', $patient->id) }}" class="space-y-5">
            @csrf @method('PUT')
            ...
            <div class="grid grid-cols-2 gap-4">
                <div>
                    ...
                    <input type="text" id="dob_display" readonly
                           value="{{ $patient->dob ? $patient->dob->format('d M Y') : '' }}"
            ...
            <div>
                ...
                <textarea name="address" rows="2"
                          class="w-full border border-gray-300 rounded-lg px-3 py-2 text-sm focus:ring-2 focus:ring-blue-500 focus:border-blue-500">{{ old('address', $patient->address) }}</textarea>
            </div>
            ...
            <div class="flex gap-3 pt-2">
                ...
                <a href="{{ route('patients.index') }}" class="bg-gray-100 hover:bg-gray-200 text-gray-700 px-6 py-2 rounded-lg text-sm font-medium transition">
                    Cancel
                </a>
            </div>
